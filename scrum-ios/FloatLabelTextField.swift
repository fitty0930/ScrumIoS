...
@IBDesignable class FloatLabelTextField: UITextField {
    ...
    @IBInspectable var titleTextColour:UIColor = UIColor(red:0.43, green:0.42, blue:0.42, alpha:1.0){
        didSet {
            if !isFirstResponder {
    ...
    @IBInspectable var titleActiveTextColour: UIColor = UIColor(red:0.67, green:0.08, blue:0.58, alpha:1.0) {
        didSet {
            if isFirstResponder {
    ...
    fileprivate func setup() {
        ...
        titleActiveTextColour = UIColor(red:0.67, green:0.08, blue:0.58, alpha:1.0)
        // Set up title label
        title.alpha = 0.0
        title.font = titleFont
        title.textColor = UIColor(red:0.43, green:0.42, blue:0.42, alpha:1.0)
